...
<body>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul class="navbar-nav ml-auto">
							<li class="nav-item "><a class="nav-link" href="index">Trang
									chủ</a></li>
							<li class="nav-item active"><a class="nav-link" href="about">Giới
									thiệu</a></li>
		...
		<div class="container py-lg-4">
			<div class="row ab-grids-sec align-items-center">
				...
				<div class="col-lg-6 ab-left pl-lg-4 mt-lg-0 mt-5">
					<h3 class="hny-title">VHP Entertainment</h3>
					...
					<div class="ready-more mt-4">
						<a href="#" class="btn read-button">Đọc thêm <span
		...
		<div class="grids-main py-5">
			<div class="container py-lg-4">
				<div class="headerhny-title">
					<h3 class="hny-title">Diễn viên của chúng tôi</h3>
				</div>
	...
	<section class="w3l-clients" id="clients">
		...
		<div class="cusrtomer-layout py-5">
			<div class="container py-lg-4">
				<div class="headerhny-title">
					<h3 class="hny-title">Đánh giá về chúng tôi</h3>
				</div>
				<!-- /grids -->
