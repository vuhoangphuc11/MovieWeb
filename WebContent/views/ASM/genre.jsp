...
<body>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul class="navbar-nav ml-auto">
							...
							<li class="nav-item "><a class="nav-link" href="about">Giới
									thiệu</a></li>
							<li class="nav-item active"><a class="nav-link" href="genre">Thể
									loại</a></li>
		...
		<nav id="breadcrumbs" class="breadcrumbs">
			<div class="container page-wrapper">
				<a href="index">Trang chủ</a> » <span class="breadcrumb_last"
					aria-current="page">Thể loại</span>
			</div>
		</nav>
	</div>
	<!--//breadcrumbs -->
				...
				<div class="owl-four owl-carousel owl-theme">
					<div class="item vhny-grid">
						<div class="box16">
							<a href="#">
								<figure>
									<img class="img-fluid" src="views/ASM/images/banner1.jpg"
										alt="">
								...
								<div class="box-content">
									...
									<h4>
										...
										</span> 1 Tiếng 4 phút </span> <span class="post fa fa-heart text-right"></span>
									</h4>
						...
						<div class="box16 mt-4">
							<a href="#">
								<figure>
									<img class="img-fluid" src=" views/ASM/images/banner2.jpg"
										alt="">
								</figure>
								<div class="box-content">
					...
					<div class="item vhny-grid">
						<div class="box16">
							<a href="#">
								<figure>
									<img class="img-fluid" src="views/ASM/images/banner3.jpg"
										alt="">
								</figure>
								<div class="box-content">
						...
						<div class="box16 mt-4">
							<a href="#">
								<figure>
									<img class="img-fluid" src="views/ASM/images/banner4.jpg"
										alt="">
								</figure>
								<div class="box-content">
	...
	<section class="w3l-grids">
		<div class="grids-main py-5">
				...
				<div class="headerhny-title">
					<div class="w3l-title-grids">
						<div class="headerhny-left">
							<h3 class="hny-title">Phim gần đây</h3>
						</div>
				...
				<div class="w3l-populohny-grids">
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<a href="#">
								<figure>
									<img class="img-fluid" src="views/ASM/images/m7.jpg" alt="">
								</figure>
								<div class="box-content">
									<h3 class="title">Frozen 2</h3>
									<h4>
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<a href="#">
								<figure>
									<img class="img-fluid" src="views/ASM/images/m3.jpg" alt="">
								</figure>
								<div class="box-content">
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<a href="#">
								<figure>
									<img class="img-fluid" src="views/ASM/images/m4.jpg" alt="">
								</figure>
								<div class="box-content">
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<a href="#">
								<figure>
									<img class="img-fluid" src="views/ASM/images/m5.jpg" alt="">
								</figure>
								<div class="box-content">
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<a href="#">
								<figure>
									<img class="img-fluid" src="views/ASM/images/m6.jpg" alt="">
								</figure>
								<div class="box-content">
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<a href="#">
								<figure>
									<img class="img-fluid" src="views/ASM/images/m10.jpg" alt="">
								</figure>
								<div class="box-content">
			...
			<div class="button-center text-center mt-3">
				<a href="#" class="btn view-button">Xem tất cả <span
	...
	<section class="w3l-grids">
		<div class="grids-main py-4">
			<div class="container py-lg-4">
				<div class="headerhny-title">
					<h3 class="hny-title">Phải xem</h3>
				</div>
						...
						<div class="two-gridshny-grids">
							<div class="two-gridshny-left">
								<div class="box16 mb-4">
									<a href="#">
										<figure>
											<img class="img-fluid" src="views/ASM/images/1.jpg" alt="">
										</figure>
										<div class="box-content">
											<h4>
												<span class="post"><span class="fa fa-clock-o">
							...
							<div class="two-gridshny-right">
								<h3>
									<a class="title-gd mt-0" href="#">Đó là những gì tôi muốn
										chỉ cho bạn cách làm ở đây.</a>
								</h3>
						...
						<div class="two-gridshny-grids">
							<div class="two-gridshny-left">
								<div class="box16 mb-4">
									<a href="#">
										<figure>
											<img class="img-fluid" src="views/ASM/images/2.jpg" alt="">
										</figure>
										<div class="box-content">
											<h4>
												<span class="post"><span class="fa fa-clock-o">
						...
						<div class="two-gridshny-grids">
							<div class="two-gridshny-left">
								<div class="box16 mb-4">
									<a href="#">
										<figure>
											<img class="img-fluid" src="views/ASM/images/3.jpg" alt="">
										</figure>
										<div class="box-content">
											<h4>
												<span class="post"><span class="fa fa-clock-o">
							...
							<div class="two-gridshny-right">
								<h3>
									<a class="title-gd mt-0" href="#">TĐó là những gì tôi muốn
										chỉ cho bạn cách làm ở đây.</a>
								</h3>
						...
						<div class="two-gridshny-grids">
							<div class="two-gridshny-left">
								<div class="box16 mb-4">
									<a href="#">
										<figure>
											<img class="img-fluid" src="views/ASM/images/4.jpg" alt="">
										</figure>
										<div class="box-content">
											<h4>
												<span class="post"><span class="fa fa-clock-o">
						...
						<div class="two-gridshny-grids">
							<div class="two-gridshny-left">
								<div class="box16 mb-4">
									<a href="#">
										<figure>
											<img class="img-fluid" src="views/ASM/images/5.jpg" alt="">
										</figure>
										<div class="box-content">
											<h4>
												<span class="post"><span class="fa fa-clock-o">
